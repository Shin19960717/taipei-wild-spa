    ...
    >
      ...
      <div className="md:hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative z-[80]">
              <div className="group relative">
                ...
                {/* Tooltip */}
                <div
                  className={`pointer-events-none absolute left-1/2 top-[120%] z-[90] w-max -translate-x-1/2 rounded-full bg-black px-3 py-1 text-[11px] tracking-[0.08em] text-white shadow-[0_8px_20px_rgba(0,0,0,0.2)] transition-all duration-200 ${
                    mobileLangOpen
              ...
              {/* iOS 風語言面板 */}
              <div
                className={`absolute right-0 top-[calc(100%+10px)] z-[90] w-[168px] origin-top-right transition-all duration-300 ease-out ${
                  mobileLangOpen
            ...
            <button
              ...
              className="relative z-[80] flex h-10 w-10 items-center justify-center rounded-md transition active:bg-black/10"
            >
        ...
        <button
          ...
          className={`fixed inset-0 z-[70] cursor-default transition-all duration-300 ${
            mobileLangOpen
              ? "pointer-events-auto bg-stone-950/10 backdrop-blur-lg opacity-100"
