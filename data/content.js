const CONTENT = {
  ...
  zh: {
    ...
    aboutHeader: "環境介紹",
    aboutTitle: "服務簡介",
    aboutText: "在 Taipei Wild Spa，我們打造的不只是按摩，而是一段完整的放鬆體驗。 每位師傅皆經過精選，具備良好體態和帥氣的臉龐與穩定運動習慣，在力量與節奏之間取得平衡，帶來細緻且有層次的服務感受。 全店採用獨立套房設計，重視隱私與舒適，讓每位顧客都能在無干擾的空間中，安心放鬆。 這裡，不只是一次體驗，而是讓人願意再次回來的地方。",
  ...
  en: {
    ...
    aboutText: "At Taipei Wild Spa, we offer more than just massage — we create a complete relaxation experience. Each therapist is carefully selected, possessing a well-maintained physique, an attractive appearance, and a consistent fitness routine. They achieve a refined balance between strength and rhythm, delivering a service that is both delicate and layered. Our entire space is designed with private suites, emphasizing privacy and comfort, allowing every guest to fully relax in an undisturbed environment. This is not just a one-time experience, but a place you will want to return to again and again.",
  ...
  ja: {
    ...
    aboutHeader: "空間紹介",
    aboutTitle: "サービス概要",
    aboutText: "Taipei Wild Spaでは、単なるマッサージではなく、心身を満たすトータルリラクゼーション体験をご提供しています。 すべてのセラピストは厳選されており、整った体型と魅力的な外見、そして安定したトレーニング習慣を備えています。力強さとリズムの絶妙なバランスにより、繊細で奥行きのある施術を実現します。 店内はすべて個室設計となっており、プライバシーと快適さを重視。誰にも邪魔されない空間で、安心してリラックスしていただけます。 ここは単なる一度きりの体験ではなく、何度でも訪れたくなる場所です。",
  ...
  ko: {
    ...
    aboutHeader: "공간 소개",
    aboutTitle: "서비스 소개",
    aboutText: "Taipei Wild Spa는 단순한 마사지가 아닌, 완전한 휴식 경험을 제공합니다. 모든 테라피스트는 엄선되어, 균형 잡힌 체형과 매력적인 외모, 꾸준한 운동 습관을 갖추고 있습니다. 힘과 리듬 사이의 조화를 통해 섬세하고 깊이 있는 서비스를 선사합니다. 전 공간은 프라이빗 룸으로 구성되어 있어, 고객의 프라이버시와 편안함을 최우선으로 고려합니다. 방해받지 않는 환경에서 안심하고 휴식을 취할 수 있습니다. 이곳은 단순한 한 번의 경험이 아닌, 다시 찾고 싶어지는 공간입니다.",
