const CONTENT = {
  ...
  zh: {
    ...
    aboutHeader: "環境介紹",
    aboutTitle: "服務簡介",
    aboutText: "在 Taipei Wild Spa，我們致力於打造同志按摩中最優質的體驗。 每位師傅皆經過精選，具備良好體態和帥氣的臉龐與穩定運動習慣，在力量與節奏之間取得平衡，帶來細緻且有層次的服務感受。 全店採用獨立套房設計，重視隱私與舒適，讓每位顧客都能在無干擾的空間中，安心放鬆。 這裡，不只是一次體驗，而是讓人願意再次回來的地方。",
    businessHoursTitle: "服務時間",
    businessHoursText: "每日 11:00 - 25:00",
    locationTitle: "服務地點",
    locationText: "台北市萬華區康定路99號",
    bookingTitle: "預約方式",
    bookingText: "為避免久候，建議至少提前一小時預約，實際服務時段與師傅排班請以客服確認為準。",
    noticeTitle: "注意事項",
    noticeText: "本店僅提供專業按摩與放鬆服務，不涉及任何形式之性交易或相關暗示行為。同時，為維護安全與品質，本店嚴禁任何毒品或違禁物品之攜帶與使用。",
    contactTitle: "聯絡方式",
  ...
  en: {
    ...
    bookingText: "To avoid waiting time, we recommend making a reservation at least one hour in advance. Actual service availability and therapist schedules are subject to confirmation with customer service.",
    noticeTitle: "Notes",
    noticeText: "We provide professional massage and relaxation services only, and do not engage in any form of sexual services or related suggestive behavior. For the sake of safety and service quality, the possession or use of drugs and illegal substances is strictly prohibited.",
  ...
  ja: {
    ...
    aboutHeader: "空間紹介",
    aboutTitle: "サービス概要",
    aboutText: "Taipei Wild Spaでは、ゲイマッサージにおいて最高品質の体験を提供することを目指しています。 すべてのセラピストは厳選されており、整った体格と魅力的な外見、そして日々のトレーニング習慣を備えています。力強さとリズムのバランスを大切にし、繊細で奥行きのある施術をご提供いたします。 店内はすべて個室設計となっており、プライバシーと快適さを重視しています。外部からの干渉を受けることなく、安心してリラックスしていただける空間です。 ここは単なる体験ではなく、また訪れたくなる場所です。",
    businessHoursTitle: "営業時間",
    businessHoursText: "毎日 11:00 - 25:00",
    locationTitle: "所在地",
    locationText: "台北市萬華區康定路99號",
    bookingTitle: "予約方法",
    bookingText: "お待ち時間を避けるため、少なくとも1時間前までのご予約をおすすめしております。実際のご案内可能時間およびセラピストの出勤状況は、カスタマーサービスにてご確認ください。",
    noticeTitle: "ご案内",
    noticeText: "当店はプロフェッショナルなマッサージおよびリラクゼーションサービスのみを提供しており、いかなる性的サービスやそれを示唆する行為も一切行っておりません。また、安全およびサービス品質の維持のため、薬物や違法物品の持ち込み・使用を固く禁止しております。",
    contactTitle: "お問い合わせ",
  ...
  ko: {
    ...
    aboutHeader: "공간 소개",
    aboutTitle: "서비스 소개",
    aboutText: "Taipei Wild Spa는 게이 마사지 분야에서 최고의 경험을 제공하는 것을 목표로 합니다. 모든 테라피스트는 엄선되어 균형 잡힌 체형과 매력적인 외모, 꾸준한 운동 습관을 갖추고 있습니다. 힘과 리듬의 조화를 통해 섬세하고 깊이 있는 서비스를 제공합니다. 매장은 전 객실 프라이빗 룸으로 구성되어 있으며, 프라이버시와 편안함을 최우선으로 합니다. 방해 없는 공간에서 안심하고 온전히 휴식을 취하실 수 있습니다. 이곳은 단순한 경험이 아닌, 다시 찾고 싶어지는 공간입니다。",
    businessHoursTitle: "영업시간",
    businessHoursText: "매일 11:00 - 25:00",
    locationTitle: "위치",
    locationText: "타이베이시 완화구 캉딩로 99호",
    bookingTitle: "예약 방법",
    bookingText: "대기 시간을 줄이기 위해 최소 1시간 전에 예약하시는 것을 권장드립니다. 실제 이용 가능 시간 및 테라피스트 스케줄은 고객센터를 통해 확인해 주시기 바랍니다。",
    noticeTitle: "안내사항",
    noticeText: "본 매장은 전문적인 마사지 및 휴식 서비스만을 제공하며, 어떠한 형태의 성적 서비스나 관련 암시 행위도 일절 제공하지 않습니다. 또한, 안전과 서비스 품질 유지를 위해 마약 및 불법 물품의 소지 및 사용을 엄격히 금지합니다.",
    contactTitle: "연락처",
