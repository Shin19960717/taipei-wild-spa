...
const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    desc: {
      ...
      en: ["171/68/31","Strong physique","Steady massage technique","Friendly and talkative","Highly cooperative and adaptable"],
      ja: ["171/68/31","しっかりした体格","安定感のある施術","明るく話しやすい雰囲気","柔軟に対応できる高い協調性"],
      ko: ["171/68/31","탄탄한 체형","안정감 있는 마사지 스타일","밝고 편안한 소통","유연하게 대응 가능한 높은 협조도"],},
    imgs: [
      "/team/Aaron01.jpg",
      "/team/Aaron02.jpg",
      "/team/Aaron03.jpg",
